...
def main(file,blur_rate):
    ...
    hats = []
    for i in range(2):
        hats.append(cv2.imread('resources/supersaiya%d.png' % i, -1))
    ...
    output_file = "resources/supersaiya_result.png"
...
root = Tk()
root.title('AI Face++ Detect + Supar Saiya（人脸探测加上变身超级赛亚人 ） —— Developed by hanshiqiang365 （微信公众号 - 韩思工作室）')
